    ...
    <div id="wrapper">
        <form @submit.prevent class="form">
         ...
         <div id="fullForm" v-if="emailEntered">
            <p><input type="text" id="username" placeholder="Username" v-model.trim="username" class="formInput" :class="{invalid:!validUsername, valid:validUsername}"></p>
            <p><input type="text" placeholder="First Name" id="firstName" v-model.trim="firstName" class="formInput" :class="{invalid:!validFirstName, valid:validFirstName}"></p>
            <p><input type="text" id="lastName" placeholder="Last Name" v-model.trim="lastName" class="formInput" :class="{invalid:!validLastName, valid:validLastName}"></p>
            <p><input type="tel" id="phoneNumber" v-model="phoneNumber" placeholder="Phone Number" class="formInput" maxlength="10"></p>
            <p>     
                ...
                <input type="password" placeholder="Password" id="password" v-model.trim="password" class="formInput" :class="{invalid:!validPassword, valid:validPassword}">
            </p>
